...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.promo-link, .komentar-link, .tpj-link, .tpc-link, .gkl-link, .plu-link, .gtw-link, .pgv-link').forEach(link => {
        link.addEventListener('click', function(e) {
            ...
            const sectionId = this.classList.contains('promo-link') ? 'promoSection' :
                             ...
                             this.classList.contains('pgv-link') ? 'pgvSection' : null;
