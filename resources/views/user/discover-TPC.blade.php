        ...
        <section class="facilities-section" id="facilities-section" data-scroll-animate="fade-up">
            ...
            <div class="facilities-grid">
                <div class="facility-item" data-scroll-animate="fade-up">
                    <img src="{{ asset('images/images/discover-TPC/Gym Area.webp') }}" alt="Siteplan" loading="lazy">
                </div>
                <div class="facility-item" data-scroll-animate="fade-up">
                    <img src="{{ asset('images/images/discover-TPC/Jogging Track.webp') }}" alt="Swimming Pool" loading="lazy">
                </div>
                <div class="facility-item" data-scroll-animate="fade-up">
                    <img src="{{ asset('images/images/discover-TPC/Lobby Area.webp') }}" alt="Lobby Area" loading="lazy">
                </div>
                <div class="facility-item" data-scroll-animate="fade-up">
                    <img src="{{ asset('images/images/discover-TPC/Mini Playground.webp') }}" alt="Playground" loading="lazy">
                </div>
                <div class="facility-item" data-scroll-animate="fade-up">
                    <img src="{{ asset('images/images/discover-TPC/Swimming Pool.webp') }}" alt="Lobby Area" loading="lazy">
                </div>
                <div class="facility-item" data-scroll-animate="fade-up">
                    <img src="{{ asset('images/images/discover-TPC/Transmall Cibubur.webp') }}" alt="Garden" loading="lazy">
                </div>
            </div>
        </section>
