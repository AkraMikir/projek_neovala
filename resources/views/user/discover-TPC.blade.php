...
@section('title', 'Discover Transpark Cibubur')
...
@section('content')
    ...
    <header class="header" id="home">
        @php
            // Extract images from carouselImagesBySection untuk TPC
            $carouselImages = [];
            if (isset($carouselImagesBySection['TPC']) && is_array($carouselImagesBySection['TPC'])) {
                // Filter null values dan keep original keys, then get values
                $carouselImages = array_values(array_filter($carouselImagesBySection['TPC'], function($value) {
        ...
        <x-carousel 
            ...
            overlay-text="TRANSPARK CIBUBUR"
    ...
    <main class="main-content">
        ...
        <section class="facilities-section" id="facilities-section" data-scroll-animate="fade-up">
            ...
            <div class="facilities-grid">
                <div class="facility-item" data-scroll-animate="fade-up">
                    <img src="{{ asset('images/images/discover-TPC/Gym Area.webp') }}" alt="Siteplan">
                </div>
                <div class="facility-item" data-scroll-animate="fade-up">
                    <img src="{{ asset('images/images/discover-TPC/Jogging Track.webp') }}" alt="Swimming Pool">
                </div>
                <div class="facility-item" data-scroll-animate="fade-up">
                    <img src="{{ asset('images/images/discover-TPC/Lobby Area.webp') }}" alt="Lobby Area">
                </div>
                <div class="facility-item" data-scroll-animate="fade-up">
                    <img src="{{ asset('images/images/discover-TPC/Mini Playground.webp') }}" alt="Playground">
                </div>
                <div class="facility-item" data-scroll-animate="fade-up">
                    <img src="{{ asset('images/images/discover-TPC/Swimming Pool.webp') }}" alt="Lobby Area">
                </div>
                <div class="facility-item" data-scroll-animate="fade-up">
                    <img src="{{ asset('images/images/discover-TPC/Transmall Cibubur.webp') }}" alt="Garden">
                </div>
            </div>
        </section>

        <section class="room-section" id="room-section" data-scroll-animate="fade-up">
            <h2 class="room-title">ROOM TRANSPARK CIBUBUR</h2>
        ...
        <x-form-checkin apartment="Transpark Cibubur Via WhatsApp" />
        ...
        <section class="order-online-card-section" id="order-online-section" data-scroll-animate="fade-up">
            <div class="order-online-card">
                <div class="order-online-card-content">
                    ...
                    <h3 class="order-online-card-title">Order Online Kamar Di Transpark Cibubur</h3>
                    ...
                    <a href="https://be.dip.id/booking/cekrooms?keyid=b78ffaf7036db64ce2437ec13dfebd44" target="_blank" rel="noopener noreferrer" class="booking-btn order-online-btn">
                        ...
                        <span>Order Online Transpark Cibubur</span>
                    </a>
                </div>
        ...
        <section class="location-section" id="location-section" data-scroll-animate="fade-up">
            ...
            <div class="location-container">
                <div class="location-map">
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3965.1430697446335!2d106.9000766737822!3d-6.375524762361701!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69ede320cd251d%3A0x57738cfae3aa5c1!2sApartemen%20Transpark%20Cibubur!5e0!3m2!1sid!2sid!4v1745117350896!5m2!1sid!2sid"
                ...
                <div class="location-info">
                    <div class="location-address">
                        ...
                        <p>Apartemen Transpark Cibubur, Jl. Alternatif Cibubur, Harjamukti, Cimanggis, Depok City, West
                            Java 16454</p>
                    </div>
                    <div class="location-features">
                        <div class="feature-item">
                            <i class="fas fa-train"></i>
                            <p>Dekat dengan Stasiun Cibubur</p>
                        </div>
                        <div class="feature-item">
                        ...
                        <div class="feature-item">
                            ...
                            <p>Dekat dengan RS Hermina Bekasi</p>
                        </div>
                        <div class="feature-item">
                            <i class="fas fa-utensils"></i>
                            <p>Dekat dengan Food Court Transmall</p>
                        </div>
                    </div>
                    <div class="direction-btn-wrapper">
                        <a href="https://g.co/kgs/hZECFj5" target="_blank" class="direction-btn">
        ...
        <section class="booking-section booking-section-TPC" id="booking-section" data-scroll-animate="fade-up">
            <div class="booking-overlay"></div>
            <div class="booking-container">
                <h2 class="booking-title">SEWA APARTEMEN<br>TRANSPARK CIBUBUR</h2>
                <h3 class="booking-subtitle">DI NEOVALA ROOM</h3>
                <div class="booking-buttons">
                    <a href="https://wa.me/6281805191817" class="booking-btn whatsapp-btn">
                    ...
                    <a href="https://www.tiket.com/homes/indonesia/neovala-at-apartemen-transpark-cibubur"
        ...
        <section class="testimoni-section" id="testimoni-section" data-scroll-animate="fade-up">
            <div class="testimoni-comments">
                ...
                <div class="testimoni-slider-container">
                    ...
                    <div class="testimoni-slider">
                        @foreach (\App\Models\KomentarTpc::where('status', 'accepted')->where('section', 'tpc')->latest()->get() as $komen)
            ...
            <div class="feedback-section">
                ...
                <form class="feedback-form" id="feedbackForm" method="POST" action="{{ route('komentar-tpc.store') }}">
                    @csrf
    ...
    <footer class="footer-discover" id="footer">
        ...
        <div class="footer-content-discover">
            ...
            <div class="footer-social-discover">
                <h3>Social Media TPC Neovala</h3>
                <div class="social-icons-discover">
                    <a href="https://instagram.com/neovala.transparkcibubur" target="_blank">
                        <i class="fab fa-instagram"></i>
                    </a>
                    <a href="https://www.facebook.com/people/Sewa-Apartemen-Transpark-Cibubur-by-Neovala/61552631619111/#"
                        target="_blank">
                        <i class="fab fa-facebook"></i>
                    </a>
                    <a href="https://tiktok.com/@neovala.transparkcibubur" target="_blank">
                        <i class="fab fa-tiktok"></i>
                    </a>
                    <a href="https://twitter.com/neovala_tpc" target="_blank">
                        <i class="fab fa-twitter"></i>
                    </a>
                    <a href="https://youtube.com/@neovalatransparkcibubur" target="_blank">
...
@push('scripts')
    ...
    document.addEventListener('DOMContentLoaded', function() {
        if (window.neovalaTracker) {
            window.neovalaTracker.trackApartmentDiscovery('Transpark Cibubur');
        }
    });
    </script>
@endpush
