...
@section('content')
    ...
    <header class="header" id="home">
        @php
            // Extract images from carouselImagesBySection untuk PGV
            $carouselImages = [];
            if (isset($carouselImagesBySection['PGV']) && is_array($carouselImagesBySection['PGV'])) {
                // Filter null values dan keep original keys, then get values
                $carouselImages = array_values(array_filter($carouselImagesBySection['PGV'], function($value) {
    ...
    <main class="main-content">
        ...
        <x-form-checkin apartment="Podomoro Golf View by Neovala" />

        <section class="order-online-card-section" id="order-online-section" data-scroll-animate="fade-up">
            <div class="order-online-card">
                <h3 class="order-online-card-title">Order Online room Podomoro Golf View</h3>
                ...
                <a href="https://be.dip.id/booking/cekrooms?keyid=02206fd5278c6653c3f27463a166eed7" target="_blank" rel="noopener noreferrer" class="booking-btn order-online-btn">
        ...
        <section class="location-section" id="location-section" data-scroll-animate="fade-up">
            ...
            <div class="location-container">
                <div class="location-map">
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d7929.476457575623!2d106.88774031851743!3d-6.427667315030398!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69f6be2a41087b%3A0x13e82aa7ed1d9f05!2sPodomoro%20Golf%20View!5e0!3m2!1sid!2sid!4v1745501332725!5m2!1sid!2sid"
                ...
                <div class="location-info">
                    <div class="location-address">
                        ...
                        <p>Apartemen PODOMORO GOLF VIEW, Jl. Alternatif Cibubur, Harjamukti, Cimanggis, Depok City, West
                            Java 16454</p>
                    </div>
                    <div class="location-features">
                        <div class="feature-item">
                            <i class="fas fa-train"></i>
                            <p>Dekat dengan Stasiun LRT Podomoro</p>
                        </div>
                        <div class="feature-item">
                            <i class="fas fa-building"></i>
                            <p>Dekat dengan Cluster Podomoro</p>
                        </div>
                        <div class="feature-item">
                            <i class="fas fa-golf-ball"></i>
                            <p>Dekat dengan Podomoro Golf Course</p>
                        </div>
                        <div class="feature-item">
                            <i class="fas fa-utensils"></i>
                            <p>Dekat dengan Food Court Podomoro</p>
                        </div>
                    </div>
                    <div class="direction-btn-wrapper">
                        <a href="https://g.co/kgs/t3h9nTP" target="_blank" class="direction-btn">
        ...
        <section class="booking-section booking-section-PGV" id="booking-section" data-scroll-animate="fade-up">
            ...
            <div class="booking-container">
                ...
                <div class="booking-buttons">
                    ...
                    <a href="https://www.tiket.com/homes/indonesia/neovala-at-apartemen-podomoro-golf-view"
    ...
    <footer class="footer-discover" id="footer">
        ...
        <div class="footer-content-discover">
            ...
            <div class="footer-social-discover">
                <h3>Social Media PGV Neovala</h3>
                <div class="social-icons-discover">
                    <a href="https://instagram.com/neovala.podomorogolfview" target="_blank">
                        <i class="fab fa-instagram"></i>
                    </a>
                    <a href="https://www.facebook.com/people/Neovala-Apartemen-Podomoro-Golf-View/61572719497997/#"
                        target="_blank">
                        <i class="fab fa-facebook-f"></i>
                    </a>
                    <a href="https://tiktok.com/@neovala.podomorogolfview" target="_blank">
                        <i class="fab fa-tiktok"></i>
                    </a>
                    <a href="https://twitter.com/neovala_pgv" target="_blank">
                        <i class="fab fa-twitter"></i>
                    </a>
                    <a href="https://youtube.com/@neovala.podomorogolfview" target="_blank">
