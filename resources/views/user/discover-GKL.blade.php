        ...
        <section class="facilities-section" id="facilities-section">
            ...
            <div class="facilities-grid">
                <div class="facility-item">
                    <img src="{{ asset('images/images/discover-GKL/Gym Area (1).jpg') }}" alt="Gym Area">
                </div>
                <div class="facility-item">
                    <img src="{{ asset('images/images/discover-GKL/Infinity Pool.jpg') }}" alt="Infinity Pool">
                </div>
                <div class="facility-item">
                    <img src="{{ asset('images/images/discover-GKL/Jogging Track (1).jpg') }}" alt="Jogging Track">
                </div>
                <div class="facility-item">
                    <img src="{{ asset('images/images/discover-GKL/Love Bridge.jpg') }}" alt="Love Bridge">
                </div>
                <div class="facility-item">
                    <img src="{{ asset('images/images/discover-GKL/Mall Lagoon Avenue.jpg') }}" alt="Mall Lagoon Avenue">
                </div>
                <div class="facility-item">
                    <img src="{{ asset('images/images/discover-GKL/Pocket Garden.jpg') }}" alt="Pocket Garden">
                </div>
            </div>
        </section>
            ...
            <div class="testimoni-comments">
                ...
                <div class="testimoni-slider-container">
                    ...
                    <div class="testimoni-slider">
                        @foreach (\App\Models\KomentarGkl::where('status', 'accepted')->where('section', 'gkl')->latest()->get() as $komen)
