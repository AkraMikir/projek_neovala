...
@section('content')
    ...
    <header class="header" id="home">
        @php
            // Extract images from carouselImagesBySection untuk TPJ
            $carouselImages = [];
            if (isset($carouselImagesBySection['TPJ']) && is_array($carouselImagesBySection['TPJ'])) {
                // Filter null values dan keep original keys, then get values
                $carouselImages = array_values(array_filter($carouselImagesBySection['TPJ'], function($value) {
    ...
    <main class="main-content">
        ...
        <section class="facilities-section" id="facilities-section" data-scroll-animate="fade-up">
            ...
            <div class="facilities-grid">
                <div class="facility-item" data-scroll-animate="fade-up">
                    <img src="{{ asset('images/images/discover-TPJ/Vendhing Machine.webp') }}" alt="Siteplan">
                </div>
                <div class="facility-item" data-scroll-animate="fade-up">
                    <img src="{{ asset('images/images/discover-TPJ/Swimming Pool.webp') }}" alt="Swimming Pool">
                </div>
                <div class="facility-item" data-scroll-animate="fade-up">
                    <img src="{{ asset('images/images/discover-TPJ/Waterplay.webp') }}" alt="Lobby Area">
                </div>
                <div class="facility-item" data-scroll-animate="fade-up">
                    <img src="{{ asset('images/images/discover-TPJ/Waterplay.webp') }}" alt="Playground">
                </div>
                <div class="facility-item" data-scroll-animate="fade-up">
                    <img src="{{ asset('images/images/discover-TPJ/Lobby Area.webp') }}" alt="Lobby Area">
                </div>
                <div class="facility-item" data-scroll-animate="fade-up">
                    <img src="{{ asset('images/images/discover-TPJ/Ecopark Garden.webp') }}" alt="Garden">
                </div>
            </div>
        </section>
        ...
        <section class="order-online-card-section" id="order-online-section" data-scroll-animate="fade-up">
            <div class="order-online-card">
                <div class="order-online-card-content">
                    ...
                    <h3 class="order-online-card-title">Order Online Kamar Di Transpark Juanda</h3>
                    ...
                    <a href="https://be.dip.id/booking/cekrooms?keyid=0c852d588be29c4fa736fae16c877bd5" target="_blank" rel="noopener noreferrer" class="booking-btn order-online-btn">
                        <i class="bi bi-fire"></i>
                        <span>Order Online Transpark Juanda</span>
                    </a>
                </div>
                <div class="order-online-card-image">
                    <img src="{{ asset('images/images/discover-TPJ/Swimming Pool.webp') }}" alt="Swimming Pool Transpark Juanda" loading="lazy">
            ...
            <div class="location-container">
                ...
                <div class="location-info">
                    <div class="location-address">
                        ...
                        <p>Jl. Insinyur H. Juanda No.19, RT.003/RW.011, Margahayu, Kec. Bekasi Tim., Kota Bks, Jawa
                            Barat 17113</p>
                    </div>
                    <div class="location-features">
                        ...
                        <div class="feature-item">
                            ...
                            <p>Dekat dengan Mall Metropolitan</p>
                        </div>
                        <div class="feature-item">
                            <i class="fas fa-hospital"></i>
                            <p>Dekat dengan RS Hermina</p>
                        </div>
                        <div class="feature-item">
                    ...
                    <div class="direction-btn-wrapper">
                        <a href="https://g.co/kgs/Wgqbiep" target="_blank" class="direction-btn">
        ...
        <section class="booking-section booking-section-TPJ" id="booking-section" data-scroll-animate="fade-up">
            ...
            <div class="booking-container">
                ...
                <div class="booking-buttons">
                    <a href="https://wa.me/6287874176270" class="booking-btn whatsapp-btn">
                    ...
                    <a href="https://www.tiket.com/homes/indonesia/neovala-at-apartemen-transpark-juanda"
        ...
        <section class="testimoni-section" id="testimoni-section" data-scroll-animate="fade-up">
            <div class="testimoni-comments">
                ...
                <div class="testimoni-slider-container">
                    ...
                    <div class="testimoni-slider">
                        @foreach (\App\Models\KomentarTpj::where('status', 'accepted')->where('section', 'tpj')->latest()->get() as $komen)
            ...
            <div class="feedback-section">
                ...
                <form class="feedback-form" id="feedbackForm" method="POST" action="{{ route('komentar-tpj.store') }}">
                    @csrf
    ...
    <footer class="footer-discover" id="footer">
        ...
        <div class="footer-content-discover">
            ...
            <div class="footer-social-discover">
                <h3>Social Media TPJ Neovala</h3>
                <div class="social-icons-discover">
                    <a href="https://www.instagram.com/neovala.transparkjuanda/" target="_blank">
                        <i class="fab fa-instagram"></i>
                    </a>
                    <a href="https://www.facebook.com/people/Penyewaan-Harian-Transpark-Juanda-Bekasi-Timur/61567154060930/#"
                        target="_blank">
                        <i class="fab fa-facebook-f"></i>
                    </a>
                    <a href="https://www.tiktok.com/@neovala.transparkjuanda" target="_blank">
                        <i class="fab fa-tiktok"></i>
                    </a>
                    <a href="https://x.com/neovala_tpj" target="_blank">
                        <i class="fab fa-twitter"></i>
                    </a>
                    <a href="https://www.youtube.com/@neovalatransparkjuanda" target="_blank">
