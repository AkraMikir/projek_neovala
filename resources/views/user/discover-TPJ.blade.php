        ...
        <section class="facilities-section" id="facilities-section">
            ...
            <div class="facilities-grid">
                <div class="facility-item">
                    <img src="{{ asset('images/images/discover-TPJ/Vendhing Machine.jpg') }}" alt="Siteplan">
                </div>
                <div class="facility-item">
                    <img src="{{ asset('images/images/discover-TPJ/Swimming Pool.jpg') }}" alt="Swimming Pool">
                </div>
                <div class="facility-item">
                    <img src="{{ asset('images/images/discover-TPJ/Waterplay.jpg') }}" alt="Lobby Area">
                </div>
                <div class="facility-item">
                    <img src="{{ asset('images/images/discover-TPJ/Waterplay.jpg') }}" alt="Playground">
                </div>
                <div class="facility-item">
                    <img src="{{ asset('images/images/discover-TPJ/Lobby Area.jpg') }}" alt="Lobby Area">
                </div>
                <div class="facility-item">
                    <img src="{{ asset('images/images/discover-TPJ/Ecopark Garden.jpg') }}" alt="Garden">
                </div>
            </div>
        </section>
