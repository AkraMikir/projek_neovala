...
@section('content')
    ...
    <header class="header" id="home">
        @php
            // Extract images from carouselImagesBySection untuk BSR
            $carouselImages = [];
            if (isset($carouselImagesBySection['BSR']) && is_array($carouselImagesBySection['BSR'])) {
                // Filter null values dan keep original keys, then get values
                $carouselImages = array_values(array_filter($carouselImagesBySection['BSR'], function($value) {
    ...
    <main class="main-content">
        ...
        <section class="facilities-section" id="facilities-section" data-scroll-animate="fade-up">
            ...
            <div class="facilities-grid">
                <div class="facility-item" data-scroll-animate="fade-up">
                    <img src="{{ asset('images/images/discover-BSC/gazebo.webp') }}" alt="Gazebo" loading="lazy">
                </div>
                <div class="facility-item" data-scroll-animate="fade-up">
                    <img src="{{ asset('images/images/discover-BSC/gym.webp') }}" alt="Gym Center" loading="lazy">
                </div>
                <div class="facility-item" data-scroll-animate="fade-up">
                    <img src="{{ asset('images/images/discover-BSC/jogging.webp') }}" alt="Jogging Track" loading="lazy">
                </div>
                <div class="facility-item" data-scroll-animate="fade-up">
                    <img src="{{ asset('images/images/discover-BSC/kolam.webp') }}" alt="Swimming Pool" loading="lazy">
                </div>
                <div class="facility-item" data-scroll-animate="fade-up">
                    <img src="{{ asset('images/images/discover-BSC/mall.webp') }}" alt="Mall Bassura" loading="lazy">
                </div>
                <div class="facility-item" data-scroll-animate="fade-up">
                    <img src="{{ asset('images/images/discover-BSC/playground.webp') }}" alt="Mini Playground" loading="lazy">
                </div>
            </div>
        </section>

        <section class="room-section" id="room-section" data-scroll-animate="fade-up">
            <h2 class="room-title">ROOM BASSURA CITY</h2>
            ...
            <div class="room-slider-container">
                ...
                <div class="room-card" data-scroll-animate="fade-up">
                    <div class="room-card-header">
                        ...
                        <div class="right-text">BASSURA <span class="room-type">CITY</span></div>
                    </div>
        ...
        <x-form-checkin apartment="Bassura City Via WhatsApp" />
            ...
            <div class="location-container">
                ...
                <div class="location-info">
                    ...
                    <div class="direction-btn-wrapper">
                        <a href="https://maps.app.goo.gl/6KWLcbRdxVhEhFov5" target="_blank" class="direction-btn">
        ...
        <section class="booking-section booking-section-BSC" id="booking-section" data-scroll-animate="fade-up">
            ...
            <div class="booking-container">
                ...
                <div class="booking-buttons">
                    ...
                    <a href="https://www.tiket.com/homes/indonesia/neovala-at-apartemen-bassura-city"
        ...
        @include('user.partials.reviews-section', ['locationName' => 'Bassura City', 'locationSlug' => 'bsr', 'carouselImages' => $carouselImages ?? []])
    </main>
    ...
    <footer class="footer-discover" id="footer">
        ...
        <div class="footer-content-discover">
            ...
            <div class="footer-social-discover">
                <h3>Social Media BSC Neovala</h3>
                <div class="social-icons-discover">
                    <a href="https://www.instagram.com/neovala.bassuracity/" target="_blank">
                        <i class="fab fa-instagram"></i>
                    </a>
                    <a href="https://www.facebook.com/people/Penyewaan-Harian-Bassura-City/61567154060930/#"
                        target="_blank">
                        <i class="fab fa-facebook-f"></i>
                    </a>
                    <a href="https://www.tiktok.com/@neovala.bassuracity" target="_blank">
