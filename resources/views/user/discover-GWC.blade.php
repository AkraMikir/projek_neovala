...
@section('content')
    ...
    <header class="header" id="home">
        @php
            // Extract images from carouselImagesBySection untuk GWC
            $carouselImages = [];
            if (isset($carouselImagesBySection['GWC']) && is_array($carouselImagesBySection['GWC'])) {
                // Filter null values dan keep original keys, then get values
                $carouselImages = array_values(array_filter($carouselImagesBySection['GWC'], function($value) {
        ...
        <section class="facilities-section" id="facilities-section">
            ...
            <div class="facilities-grid">
                <div class="facility-item">
                    <img src="{{ asset('images/images/discover-GWC/Basketball Court.webp') }}" alt="Siteplan">
                </div>
                <div class="facility-item">
                ...
                <div class="facility-item">
                    <img src="{{ asset('images/images/discover-GWC/Indomaret Fresh.webp') }}" alt="Lobby Area">
                </div>
                <div class="facility-item">
                    <img src="{{ asset('images/images/discover-GWC/Lobby Area (1).webp') }}" alt="Playground">
                </div>
                <div class="facility-item">
                    <img src="{{ asset('images/images/discover-GWC/Masjid.webp') }}" alt="Lobby Area">
                </div>
                <div class="facility-item">
                    <img src="{{ asset('images/images/discover-GWC/Rooftop.webp') }}" alt="Garden">
                </div>
            </div>
        </section>
            ...
            <div class="location-container">
                ...
                <div class="location-info">
                    ...
                    <div class="direction-btn-wrapper">
                        <a href="https://maps.app.goo.gl/ZyHRizNpSDWNsvmdA" target="_blank" class="direction-btn">
            ...
            <div class="testimoni-comments">
                ...
                <div class="testimoni-slider-container">
                    ...
                    <div class="testimoni-slider">
                        @foreach (\App\Models\KomentarGwc::where('status', 'accepted')->where('section', 'gwc')->latest()->get() as $komen)
