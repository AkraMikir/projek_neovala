...
@section('title', 'Discover Patraland Urbano')
...
@section('content')
    ...
    <header class="header" id="home">
        @php
            // Extract images from carouselImagesBySection untuk PLU
            $carouselImages = [];
            if (isset($carouselImagesBySection['PLU']) && is_array($carouselImagesBySection['PLU'])) {
                // Filter null values dan keep original keys, then get values
                $carouselImages = array_values(array_filter($carouselImagesBySection['PLU'], function($value) {
    ...
    <main class="main-content">
        ...
        <x-form-checkin apartment="Patraland Urbano Via WhatsApp" />
        ...
        <section class="order-online-card-section" id="order-online-section">
            <div class="order-online-card">
                <div class="order-online-card-content">
                    ...
                    <h3 class="order-online-card-title">Order Online Kamar Di Patraland Urbano</h3>
                    ...
                    <a href="https://be.dip.id/booking/cekrooms?keyid=e57d71fa4ee77bf374f103f2eecabbe6" target="_blank" rel="noopener noreferrer" class="booking-btn order-online-btn">
                        ...
                        <span>Order Online Patraland Urbano</span>
                    </a>
                </div>
                <div class="order-online-card-image">
                    <img src="{{ asset('images/images/discover-PLU/Swimming Pool (1).webp') }}" alt="Swimming Pool Patraland Urbano" loading="lazy">
        ...
        @include('user.partials.reviews-section', ['locationName' => 'Patraland Urbano', 'locationSlug' => 'plu', 'carouselImages' => $carouselImages ?? []])
    </main>
        ...
        <div class="footer-content-discover">
            ...
            <div class="footer-social-discover">
                ...
                <div class="social-icons-discover">
                    ...
                    <a href="https://www.facebook.com/people/Neovala-Patraland-Urbano/61552631619111/" target="_blank">
