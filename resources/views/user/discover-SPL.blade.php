...
@section('content')
    ...
    <header class="header" id="home">
        @php
            // Extract images from carouselImagesBySection untuk SPL
            $carouselImages = [];
            if (isset($carouselImagesBySection['SPL']) && is_array($carouselImagesBySection['SPL'])) {
                // Filter null values dan keep original keys, then get values
                $carouselImages = array_values(array_filter($carouselImagesBySection['SPL'], function($value) {
        ...
        <x-carousel 
            ...
            overlay-text="SPRINGLAKE SUMMARECON"
    ...
    <main class="main-content">
        ...
        <section class="order-online-card-section" id="order-online-section" data-scroll-animate="fade-up">
            <div class="order-online-card">
                <div class="order-online-card-content">
                    ...
                    <h3 class="order-online-card-title">Order Online Kamar Di Springlake Summarecon</h3>
                    ...
                    <a href="https://be.dip.id/booking/cekrooms?keyid=eff54e59745a24240872b623a49a1dc1" target="_blank" rel="noopener noreferrer" class="booking-btn order-online-btn">
                        ...
                        <span>Order Online Springlake Summarecon</span>
                    </a>
                </div>
        ...
        <section class="location-section" id="location-section" data-scroll-animate="fade-up">
            ...
            <div class="location-container">
                <div class="location-map">
                    <iframe
                         src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15865.78854432135!2d106.9961234!3d-6.2255883!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e698c6900964f69%3A0xd7e05fc86be78a2!2sThe%20Springlake%20Summarecon%20Bekasi!5e0!3m2!1sen!2sid!4v1700000000000!5m2!1sen!2sid"
                ...
                <div class="location-info">
                    <div class="location-address">
                        ...
                        <p>Jl. Bulevar Ahmad Yani, Marga Mulya, Kec. Bekasi Utara, Kota Bekasi, Jawa Barat 17143</p>
                    </div>
                    <div class="location-features">
                        <div class="feature-item">
                            <i class="fas fa-train"></i>
                            <p>Dekat Stasiun Bekasi</p>
                        </div>
                        <div class="feature-item">
                            <i class="fas fa-shopping-cart"></i>
                            <p>Dekat Summarecon Mall Bekasi</p>
                        </div>
                        <div class="feature-item">
                            <i class="fas fa-hospital"></i>
                            <p>Dekat RS Mitra Keluarga</p>
                        </div>
                         <div class="feature-item">
                    ...
                    <div class="direction-btn-wrapper">
                        <a href="https://maps.app.goo.gl/SpringlakeSummarecon" target="_blank" class="direction-btn">
        ...
        <section class="testimoni-section" id="testimoni-section" data-scroll-animate="fade-up">
            <div class="testimoni-comments">
                ...
                <div class="testimoni-slider-container">
                    ...
                    <div class="testimoni-slider">
                        @foreach (\App\Models\KomentarSpl::where('status', 'accepted')->where('section', 'spl')->latest()->get() as $komen)
            ...
            <div class="feedback-section">
                ...
                <form class="feedback-form" id="feedbackForm" method="POST" action="{{ route('komentar-spl.store') }}">
                    @csrf
    ...
    <footer class="footer-discover" id="footer">
        ...
        <div class="footer-content-discover">
            ...
            <div class="footer-social-discover">
                <h3>Social Media SPL Neovala</h3>
...
@push('scripts')
    ...
    document.addEventListener('DOMContentLoaded', function() {
        if (window.neovalaTracker) {
            window.neovalaTracker.trackApartmentDiscovery('Springlake Summarecon');
        }
    });
    </script>
@endpush
