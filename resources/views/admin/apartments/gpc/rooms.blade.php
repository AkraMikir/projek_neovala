    ...
    <div class="room-cards">
        ...
        <div class="room-card">
            <div class="room-card-header">
                ...
                <div class="right-text">TRANSPARK <span class="room-type">PRAMUKA</span></div>
            </div>
            ...
            <div class="room-action-buttons">
                ...
                <button class="edit-room-btn" 
                        ...
                        data-update-url="{{ route('admin.dashboard1.gpc.updateRoom', $room['id']) }}"
                ...
                <form action="{{ route('admin.dashboard1.gpc.deleteRoom', $room['id']) }}" method="POST" class="d-inline" onsubmit="event.preventDefault(); confirmDelete(this);">
                    @csrf
                    @method('DELETE')
