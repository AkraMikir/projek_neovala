<div class="change-slide-section" id="changeSlideSection" style="display: none;">
    <form action="{{ route('admin.dashboard1.gkl.updateCarousel') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <input type="hidden" name="section" value="GKL">
            ...
            <div class="slide-item" data-index="{{ $i-1 }}">
                <div class="slide-image">
                    <img src="{{ $carouselImages[$i] ? asset('storage/' . $carouselImages[$i]) : asset('img/default-slide.webp') }}"
                        alt="Slide {{ $i }} GKL" id="previewSlide{{ $i }}">
