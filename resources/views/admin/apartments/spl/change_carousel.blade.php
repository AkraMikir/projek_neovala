<div class="change-slide-section" id="changeSlideSection" style="display: none;">
    <form action="{{ route('admin.dashboard1.spl.updateCarousel') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <input type="hidden" name="section" value="SPL">

        <div class="header-admin">
            <header>
                <h1>Change Slide Springlake Summarecon</h1>
            </header>
