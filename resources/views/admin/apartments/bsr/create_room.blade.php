<div class="create-room-section" id="createRoomSection" style="display: none;">
    <div class="header-admin">
        <header>
            <h1>Buat Room Bassura City</h1>
        </header>
    </div>

    <form action="{{ route('admin.dashboard1.bsr.storeRoom') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <input type="hidden" name="room_section" value="room_bassura_city">
