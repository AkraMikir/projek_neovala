        ...
        <div class="room-card">
            ...
            <div class="room-action-buttons">
                ...
                <button class="edit-room-btn" 
                        ...
                        data-update-url="{{ route('admin.dashboard1.tpc.updateRoom', $room['id']) }}"
                ...
                <form action="{{ route('admin.dashboard1.tpc.deleteRoom', $room['id']) }}" method="POST" class="d-inline" onsubmit="event.preventDefault(); confirmDelete(this);">
                    @csrf
                    @method('DELETE')
